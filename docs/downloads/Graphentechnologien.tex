...
\chapter{Die Downloadformate des DTA}\label{die-downloadformate-des-dta}
...
\chapter{Vorbereitungen}\label{vorbereitungen}
...
\chapter{Import des TCF-Formats}\label{import-des-tcf-formats}

\section{Tokenimport}\label{tokenimport}
...
\section{Satzstrukturen}\label{satzstrukturen}
...
\section{Lemmaimport}\label{lemmaimport}
...
\section{Beispielabfrage}\label{beispielabfrage}
...
\chapter{Import der TEIP5-Fassung}\label{import-der-teip5-fassung}
...
\chapter{Zusammenfassung}\label{zusammenfassung-3}
...
\begin{longtable}[]{@{}lr@{}}
\toprule
Element & Anzahl\tabularnewline
\midrule
\endhead
lb & 16075\tabularnewline
hi & 3768\tabularnewline
choice & 2184\tabularnewline
expan & 1856\tabularnewline
abbr & 1856\tabularnewline
supplied & 1517\tabularnewline
persName & 925\tabularnewline
note & 914\tabularnewline
add & 782\tabularnewline
del & 644\tabularnewline
unclear & 526\tabularnewline
subst & 516\tabularnewline
pb & 422\tabularnewline
gap & 419\tabularnewline
fw & 357\tabularnewline
p & 238\tabularnewline
metamark & 234\tabularnewline
reg & 221\tabularnewline
orig & 221\tabularnewline
corr & 107\tabularnewline
sic & 107\tabularnewline
div & 64\tabularnewline
head & 63\tabularnewline
item & 51\tabularnewline
rendition & 22\tabularnewline
space & 20\tabularnewline
ref & 19\tabularnewline
bibl & 15\tabularnewline
list & 13\tabularnewline
idno & 12\tabularnewline
surname & 12\tabularnewline
forename & 12\tabularnewline
figure & 10\tabularnewline
milestone & 9\tabularnewline
orgName & 7\tabularnewline
resp & 6\tabularnewline
respStmt & 6\tabularnewline
editor & 6\tabularnewline
cell & 6\tabularnewline
measure & 4\tabularnewline
titlePart & 4\tabularnewline
classCode & 4\tabularnewline
handNote & 4\tabularnewline
date & 2\tabularnewline
edition & 2\tabularnewline
titleStmt & 2\tabularnewline
editionStmt & 2\tabularnewline
publisher & 2\tabularnewline
publicationStmt & 2\tabularnewline
title & 2\tabularnewline
author & 2\tabularnewline
pubPlace & 2\tabularnewline
row & 2\tabularnewline
biblFull & 1\tabularnewline
fileDesc & 1\tabularnewline
editorialDecl & 1\tabularnewline
text & 1\tabularnewline
physDesc & 1\tabularnewline
back & 1\tabularnewline
sourceDesc & 1\tabularnewline
address & 1\tabularnewline
country & 1\tabularnewline
textClass & 1\tabularnewline
titlePage & 1\tabularnewline
repository & 1\tabularnewline
encodingDesc & 1\tabularnewline
front & 1\tabularnewline
availability & 1\tabularnewline
msDesc & 1\tabularnewline
addrLine & 1\tabularnewline
byline & 1\tabularnewline
body & 1\tabularnewline
typeDesc & 1\tabularnewline
teiHeader & 1\tabularnewline
docTitle & 1\tabularnewline
licence & 1\tabularnewline
msIdentifier & 1\tabularnewline
profileDesc & 1\tabularnewline
tagsDecl & 1\tabularnewline
email & 1\tabularnewline
TEI & 1\tabularnewline
table & 1\tabularnewline
langUsage & 1\tabularnewline
docAuthor & 1\tabularnewline
extent & 1\tabularnewline
language & 1\tabularnewline
handDesc & 1\tabularnewline
\bottomrule
\end{longtable}
...
\chapter{cypher-Dokumentation}\label{cypher-dokumentation}

Die Dokumentation von cypher findet sich auf den Seiten von neo4j: \url{https://neo4j.com/docs/developer-manual/current/}

\chapter{Analyse der Graphdaten}\label{analyse-der-graphdaten}

\section{Welche und jeweils wieviele Knoten enthält die Datenbank}\label{welche-und-jeweils-wieviele-knoten-enthuxe4lt-die-datenbank}
...
\section{Welche Verknüpfungen gibt es in der Datenbank und wie häufig sind sie}\label{welche-verknuxfcpfungen-gibt-es-in-der-datenbank-und-wie-huxe4ufig-sind-sie}
...
\section{Welche Knoten haben keine Kanten}\label{welche-knoten-haben-keine-kanten}
...
\chapter{Weitere Labels für einen Knoten}\label{weitere-labels-fuxfcr-einen-knoten}
...
\chapter{CSV-Feld enthält mehrere Werte}\label{csv-feld-enthuxe4lt-mehrere-werte}
...
\chapter{Regluäre Ausdrücke}\label{regluuxe4re-ausdruxfccke}
...
\chapter{Vorkommende Wörter in einer Textproperty zählen}\label{vorkommende-wuxf6rter-in-einer-textproperty-zuxe4hlen}
...
\chapter{\texorpdfstring{\texttt{MERGE} schlägt fehl da eine Property NULL ist}{MERGE schlägt fehl da eine Property NULL ist}}\label{merge-schluxe4gt-fehl-da-eine-property-null-ist}
...
\chapter{Knoten hat bestimmte Kante nicht}\label{knoten-hat-bestimmte-kante-nicht}
...
\chapter{Häufigkeit von Wortketten}\label{huxe4ufigkeit-von-wortketten}
...
\chapter{\texorpdfstring{Der \texttt{WITH}-Befehl}{Der WITH-Befehl}}\label{der-with-befehl}
...
\chapter{Die Apoc-Bibliothek}\label{die-apoc-bibliothek}
...
\section{Installation in neo4j}\label{installation-in-neo4j}
...
\section{Installation unter neo4j-Desktop}\label{installation-unter-neo4j-desktop}
...
\section{Liste aller Funktionen}\label{liste-aller-funktionen}
...
\section{Dokumentation aller Funktionen}\label{dokumentation-aller-funktionen}
...
\chapter{apoc.xml.import}\label{apoc.xml.import}
...
\chapter{(apoc.load.json)}\label{apoc.load.json}
