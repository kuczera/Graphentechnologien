...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.65\columnwidth}\raggedright\strut
Adalbero, Metzer Domkanoniker, Kanzler Heinrichs IV., Kanzler (Gegen)Kg.
Rudolfs v. Rheinfelden\strut
\end{minipage} & \begin{minipage}[t]{0.17\columnwidth}\raggedleft\strut
schenken\strut
\end{minipage} & \begin{minipage}[t]{0.09\columnwidth}\raggedleft\strut
21\strut
...
\end{figure}
\footnotetext{Die Darstellung der Wortkette ist zwischen den Wortknoten
  \emph{der} und \emph{einem} zu Gunsten der Übersichtlichkeit gekürzt.}
